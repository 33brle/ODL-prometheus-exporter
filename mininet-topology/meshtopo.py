...
def mesh_topology(controller_ip, controller_port, num_hosts):
    """
    Create a mesh topology in Mininet with a remote SDN controller.
...
if __name__ == '__main__':
    ...
    if len(sys.argv) != 4:
        print("Usage: sudo python3 mesh_topology.py <controller-ip> <controller-port> <num-hosts>")
        sys.exit(1)
    ...
    mesh_topology(controller_ip, controller_port, num_hosts)
